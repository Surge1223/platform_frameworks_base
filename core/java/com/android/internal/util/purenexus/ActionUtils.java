...
public class ActionUtils {
    ...
    private static String killForegroundAppInternal(Context context, int userId)
        ...
        try {
            ...
            List<UsageStats> recentApps = usageStatsManager.queryUsageStats(UsageStatsManager.INTERVAL_DAILY, past, current);
            ...
            if (pkg != null && !pkg.equals("com.android.systemui") && !pkg.equals(defaultHomePackage)) {
