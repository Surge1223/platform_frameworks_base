...
// source: frameworks/base/tools/aapt2/Format.proto

#ifndef PROTOBUF_frameworks_2fbase_2ftools_2faapt2_2fFormat_2eproto__INCLUDED
#define PROTOBUF_frameworks_2fbase_2ftools_2faapt2_2fFormat_2eproto__INCLUDED
...
void protobuf_AddDesc_frameworks_2fbase_2ftools_2faapt2_2fFormat_2eproto();
void protobuf_AssignDesc_frameworks_2fbase_2ftools_2faapt2_2fFormat_2eproto();
void protobuf_ShutdownFile_frameworks_2fbase_2ftools_2faapt2_2fFormat_2eproto();
...
class ConfigDescription : public ::google::protobuf::MessageLite {
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_frameworks_2fbase_2ftools_2faapt2_2fFormat_2eproto_impl();
  #else
  friend void  protobuf_AddDesc_frameworks_2fbase_2ftools_2faapt2_2fFormat_2eproto();
  #endif
  friend void protobuf_AssignDesc_frameworks_2fbase_2ftools_2faapt2_2fFormat_2eproto();
  friend void protobuf_ShutdownFile_frameworks_2fbase_2ftools_2faapt2_2fFormat_2eproto();
...
class CompiledFile_Symbol : public ::google::protobuf::MessageLite {
 public:
  ...
  ::google::protobuf::uint32 line_no() const;
  void set_line_no(::google::protobuf::uint32 value);
...
class CompiledFile : public ::google::protobuf::MessageLite {
 public:
  ...
  int exported_symbols_size() const;
  void clear_exported_symbols();
  static const int kExportedSymbolsFieldNumber = 4;
  const ::aapt::pb::CompiledFile_Symbol& exported_symbols(int index) const;
  ::aapt::pb::CompiledFile_Symbol* mutable_exported_symbols(int index);
  ::aapt::pb::CompiledFile_Symbol* add_exported_symbols();
  ::google::protobuf::RepeatedPtrField< ::aapt::pb::CompiledFile_Symbol >*
      mutable_exported_symbols();
  const ::google::protobuf::RepeatedPtrField< ::aapt::pb::CompiledFile_Symbol >&
...
class ResourceTable : public ::google::protobuf::MessageLite {
 public:
  ...
  const ::aapt::pb::StringPool& string_pool() const;
  ::aapt::pb::StringPool* mutable_string_pool();
  ::aapt::pb::StringPool* release_string_pool();
  void set_allocated_string_pool(::aapt::pb::StringPool* string_pool);
  ...
  bool has_symbol_pool() const;
  void clear_symbol_pool();
  static const int kSymbolPoolFieldNumber = 3;
  const ::aapt::pb::StringPool& symbol_pool() const;
  ::aapt::pb::StringPool* mutable_symbol_pool();
  ::aapt::pb::StringPool* release_symbol_pool();
  void set_allocated_symbol_pool(::aapt::pb::StringPool* symbol_pool);

  // repeated .aapt.pb.Package packages = 4;
  int packages_size() const;
  void clear_packages();
  static const int kPackagesFieldNumber = 4;
  const ::aapt::pb::Package& packages(int index) const;
  ::aapt::pb::Package* mutable_packages(int index);
  ::aapt::pb::Package* add_packages();
...
class Package : public ::google::protobuf::MessageLite {
 public:
  ...
  const ::aapt::pb::Type& types(int index) const;
  ::aapt::pb::Type* mutable_types(int index);
  ::aapt::pb::Type* add_types();
...
class Type : public ::google::protobuf::MessageLite {
 public:
  ...
  const ::aapt::pb::Entry& entries(int index) const;
  ::aapt::pb::Entry* mutable_entries(int index);
  ::aapt::pb::Entry* add_entries();
...
class Entry : public ::google::protobuf::MessageLite {
 public:
  ...
  const ::aapt::pb::ConfigValue& config_values(int index) const;
  ::aapt::pb::ConfigValue* mutable_config_values(int index);
  ::aapt::pb::ConfigValue* add_config_values();
...
class Source : public ::google::protobuf::MessageLite {
 public:
  ...
  bool has_col_no() const;
  void clear_col_no();
  static const int kColNoFieldNumber = 3;
  ::google::protobuf::uint32 col_no() const;
  void set_col_no(::google::protobuf::uint32 value);
...
class Reference : public ::google::protobuf::MessageLite {
 public:
  ...
  bool has_symbol_idx() const;
  void clear_symbol_idx();
  static const int kSymbolIdxFieldNumber = 3;
  ::google::protobuf::uint32 symbol_idx() const;
  void set_symbol_idx(::google::protobuf::uint32 value);
...
class Attribute : public ::google::protobuf::MessageLite {
 public:
  ...
  const ::aapt::pb::Attribute_Symbol& symbols(int index) const;
  ::aapt::pb::Attribute_Symbol* mutable_symbols(int index);
  ::aapt::pb::Attribute_Symbol* add_symbols();
...
class Style : public ::google::protobuf::MessageLite {
 public:
  ...
  void clear_entries();
  static const int kEntriesFieldNumber = 3;
  const ::aapt::pb::Style_Entry& entries(int index) const;
  ::aapt::pb::Style_Entry* mutable_entries(int index);
  ::aapt::pb::Style_Entry* add_entries();
...
class Styleable : public ::google::protobuf::MessageLite {
 public:
  ...
  const ::aapt::pb::Styleable_Entry& entries(int index) const;
  ::aapt::pb::Styleable_Entry* mutable_entries(int index);
  ::aapt::pb::Styleable_Entry* add_entries();
...
class Array_Entry : public ::google::protobuf::MessageLite {
 public:
  ...
  inline Array_Entry* New() const { return New(NULL); }

  Array_Entry* New(::google::protobuf::Arena* arena) const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(Array_Entry* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _arena_ptr_;
  }
...
class Array : public ::google::protobuf::MessageLite {
 public:
  ...
  void clear_entries();
  static const int kEntriesFieldNumber = 1;
  const ::aapt::pb::Array_Entry& entries(int index) const;
  ::aapt::pb::Array_Entry* mutable_entries(int index);
  ::aapt::pb::Array_Entry* add_entries();
  ::google::protobuf::RepeatedPtrField< ::aapt::pb::Array_Entry >*
      mutable_entries();
  const ::google::protobuf::RepeatedPtrField< ::aapt::pb::Array_Entry >&
      entries() const;
...
class Plural : public ::google::protobuf::MessageLite {
 public:
  ...
  void clear_entries();
  static const int kEntriesFieldNumber = 1;
  const ::aapt::pb::Plural_Entry& entries(int index) const;
  ::aapt::pb::Plural_Entry* mutable_entries(int index);
  ::aapt::pb::Plural_Entry* add_entries();
...
inline ::std::string* CompiledFile_Symbol::release_resource_name() {
  // @@protoc_insertion_point(field_release:aapt.pb.CompiledFile.Symbol.resource_name)
  clear_has_resource_name();
...
inline ::std::string* CompiledFile::release_resource_name() {
  // @@protoc_insertion_point(field_release:aapt.pb.CompiledFile.resource_name)
  clear_has_resource_name();
  return resource_name_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::aapt::pb::ConfigDescription* CompiledFile::release_config() {
  // @@protoc_insertion_point(field_release:aapt.pb.CompiledFile.config)
  clear_has_config();
...
inline ::std::string* CompiledFile::release_source_path() {
  // @@protoc_insertion_point(field_release:aapt.pb.CompiledFile.source_path)
  clear_has_source_path();
...
inline ::aapt::pb::StringPool* ResourceTable::mutable_string_pool() {
  set_has_string_pool();
  if (string_pool_ == NULL) {
    string_pool_ = new ::aapt::pb::StringPool;
  }
...
inline ::aapt::pb::StringPool* ResourceTable::release_string_pool() {
  // @@protoc_insertion_point(field_release:aapt.pb.ResourceTable.string_pool)
  clear_has_string_pool();
...
inline ::aapt::pb::StringPool* ResourceTable::mutable_symbol_pool() {
  set_has_symbol_pool();
  if (symbol_pool_ == NULL) {
    symbol_pool_ = new ::aapt::pb::StringPool;
  }
...
inline ::aapt::pb::StringPool* ResourceTable::release_symbol_pool() {
  // @@protoc_insertion_point(field_release:aapt.pb.ResourceTable.symbol_pool)
  clear_has_symbol_pool();
...
inline ::aapt::pb::Source* Array_Entry::release_source() {
  // @@protoc_insertion_point(field_release:aapt.pb.Array.Entry.source)
  clear_has_source();
  ::aapt::pb::Source* temp = source_;
  source_ = NULL;
  return temp;
...
inline ::std::string* Array_Entry::release_comment() {
  // @@protoc_insertion_point(field_release:aapt.pb.Array.Entry.comment)
  clear_has_comment();
  return comment_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::aapt::pb::Item* Array_Entry::release_item() {
  // @@protoc_insertion_point(field_release:aapt.pb.Array.Entry.item)
  clear_has_item();
  ::aapt::pb::Item* temp = item_;
  item_ = NULL;
  return temp;
...
#endif  // PROTOBUF_frameworks_2fbase_2ftools_2faapt2_2fFormat_2eproto__INCLUDED
